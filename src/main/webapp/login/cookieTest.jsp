...
*/
	...
	Cookie ck2=new Cookie("visitTime",visitTime);
  	...
  	//[2] 쿠키 속성 설정 단계 (유효시간, 도메인, 경로 등...)
	ck1.setMaxAge(60*60*24*3); //3일간유효 (60초*60분*24시*3 = 3일)
	ck2.setMaxAge(60*60*24*7); //7일간유효 (60초*60분*24시*7 = 7일)
	//setMaxAge()로 expiry(유효기간)을 설정한다. 0값을 주면 쿠키는 자동으로 삭제된다.
	//	->ck1.setMaxAge(0) = 쿠기삭제
	ck1.setPath("/");
